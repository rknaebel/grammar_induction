...
do
    ...
    do
        ...
        ./bin/evalb -p bin/EVALB/sample/sample.prm $EVAL/${fold}/testfunql.${fold} $GDIR/${fold}/parsed${i}.eval > $GDIR/${fold}/parsed${i}.results
        $PY extract/extractResults.py $GDIR/${fold}/parsed${i}.results $RESULTS
        
        rm $GDIR/${fold}/parsed${i}.tolisp
        rm $GDIR/${fold}/parsed${i}.lisp 
        rm $GDIR/${fold}/parsed${i}.eval
        rm $GDIR/${fold}/parsed${i}.results
        ...
        rm $GDIR/${fold}/parsed${i}_em.results
    done
    ...
    do
        ...
        rm $GDIR/${fold}/parsed${i}_llm.results
    done
    ...
    do
        ...
        rm $GDIR/${fold}/parsed3_split${i}.results
    done
